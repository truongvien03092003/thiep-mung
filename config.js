...
const eventName = 'Chúc Mừng Noel vui vẻ';
const titleCard = 'Tặng em yêu';
const contentCard = 'Chúc honey của anh Noel tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
